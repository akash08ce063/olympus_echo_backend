...
from api.v1.routes import (
    ...
    twilio_test_routes, web_test_routes
)
...
v1_router.include_router(test_suits_routes.router)  # Web scaled testing
...
v1_router.include_router(twilio_test_routes.router)  # Twilio media-stream testing
v1_router.include_router(web_test_routes.router)  # Web media-stream testing
